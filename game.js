 ...
 ***********************************************************************/
function __Player() {
__instance_init__(this, Player, null, 1, 0, heroMask, 1, 0);
this.on_creation = function() {
with(this) {
this.rotationSpeed = 2;
this.linearSpeed = 1;
this.jumpingFrame = 10;
this.throwingFrame = 5;
this.dyingTime = 70;
this.frame = 0;
this.isJumping = false;
this.isThrowing = false;
this.isDying = false;
this.jumpingEnergy = 200;
this.jumpingHeight = 50;
this.energyMax = 1000;
this.heightMax = 1000;
this.totalEnergy = energyMax;
this.totalHeight = heightMax;
this.targetHeight = heightMax;
this.started = false;
}
};
...
if(!isJumping && !isThrowing && key_down[vk_z] && totalEnergy >= jumpingEnergy && totalHeight >= targetHeight)
{
totalEnergy -= jumpingEnergy;
targetHeight += jumpingHeight;
isJumping = true;
frame = 0;
}
if(!isJumping && !isThrowing && key_down[vk_x])
{
var crt = instance_create(x, y, playerBullet);
crt.direction = direction;
crt.speed = 4;
isThrowing = true;
frame = 0;
}
...
{
frame += 1;
if(frame > jumpingFrame*5)
{
frame = 0;
isJumping = false;
}
}
else if(totalEnergy < energyMax)
{
totalEnergy += 1;
}
...
if(targetHeight > heightMax)
{
targetHeight = heightMax;
}
...
{
if(global.leftAudio <= 0 && ! global.mute)
{
sound_stop_all();
sound_loop(MainTheme);
global.leftAudio = 57*60;
}
started = true;
}
}
if(global.leftAudio > 0)
{
global.leftAudio -= 1;
}
if(key_down[vk_m])
...
with(this) {
this.other = this.place_meeting(this.x, this.y, heigthRock1);
if(this.other != null) {
isDying = true;
x = xprevious;
y = yprevious;
...
this.other = this.place_meeting(this.x, this.y, dragonFire);
if(this.other != null) {
isDying = true;
}
}
...
if(isJumping)
{
switch(Math.floor(frame / jumpingFrame))
{
case 0:
draw_sprite_ext(heroSprite, 1, x, y, 1, 1, direction, 100);
break;
case 1:
draw_sprite_ext(heroSprite, 2, x, y, 1, 1, direction, 100);
break;
case 2:
draw_sprite_ext(heroSprite, 3, x, y, 1, 1, direction, 100);
break;
case 3:
draw_sprite_ext(heroSprite, 2, x, y, 1, 1, direction, 100);
break;
...
break;
default:
draw_sprite_ext(heroSprite, 0, x, y, 1, 1, direction, 100);
break;
}
}
else if(isThrowing)
{
switch(Math.floor(frame / throwingFrame))
{
case 0:
draw_sprite_ext(heroGunSprite, 1, x, y,1, 1, direction, 100);
break;
case 1:
draw_sprite_ext(heroGunSprite, 2, x, y, 1, 1, direction, 100);
break;
case 2:
draw_sprite_ext(heroGunSprite, 3, x, y, 1, 1, direction, 100);
break;
case 3:
draw_sprite_ext(heroGunSprite, 2, x, y,  1, 1,  direction, 100);
break;
...
break;
default:
draw_sprite_ext(heroGunSprite, 0, x, y,  1, 1,  direction, 100);
break;
}
	draw_sprite_ext(heroSprite, 0, x, y, 1, 1, direction, 100);
}
...
if(frame <= dyingTime)
{
draw_sprite_ext(heroSprite, 0, x, y, 1-0.01*frame, 1-0.01*frame, direction+frame, 100 - frame);
}
else
{
...
function __heigthRock1() {
__instance_init__(this, heigthRock1, null, 0, 0, high1, 1, 1);
...
}; var heigthRock1 = new __heigthRock1();

function __windGenerator() {
__instance_init__(this, windGenerator, null, 1, 0, windSprite, 1, 190);
this.on_creation = function() {
with(this) {
this.windReload = 0;
this.windExists = true;
this.frame = Math.random()*50;
this.frameTime = 50;
this.disapear = 0;
}
};
...
if(this.frame < this.frameTime*4)
{
this.frame += 1;
}
else
...
this.on_collision = function() {
with(this) {
this.other = this.place_meeting(this.x, this.y, Player);
if(this.other != null) {
if(this.windExists)
{
other.targetHeight += 300;
this.windReload = 2000;
this.windExists = false;
this.disapear = 60;
}
}
}
...
if(this.windExists)
{
draw_sprite_ext(windSprite, Math.floor(this.frame/this.frameTime), x, y, 2, 2, 0, 0.5);
}
else if(disapear > 0)
{
draw_sprite_ext(windSprite, Math.floor(this.frame/this.frameTime), x, y, 1.5, 1.5, 0, 0.4);
}
}
}
};
}; var windGenerator = new __windGenerator();

function __birdObject() {
__instance_init__(this, birdObject, null, 1, -1, angryBirdSprite, 1, 194);
this.on_creation = function() {
with(this) {
this.flyingHeight = Math.random()*2000;
...
this.other = this.place_meeting(this.x, this.y, Player);
if(this.other != null) {
if(! other.isDying && other.totalHeight >= this.flyingHeight-200 && other.totalHeight <= this.flyingHeight+200)
{
other.isDying = true;
}
}
...
__handle_sprite__(this);
with(this) {
if(instance_list(Player).length > 0)
{
if(instance_list(Player)[0].totalHeight <= this.flyingHeight + 200 && instance_list(Player)[0].totalHeight >= this.flyingHeight - 200)
{
this.depth = -1;
draw_sprite_ext(angryBirdSprite, 0, x, y, 0.4, 0.4, direction, 1);
}
else if(instance_list(Player)[0].totalHeight > this.flyingHeight)
{
this.depth = 1;
draw_sprite_ext(birdHeight, 0, x, y, 0.2, 0.2, direction, 0.5);
}
else
{
this.depth = -2;
draw_sprite_ext(angryBirdSprite, 0, x, y, 0.6, 0.6, direction, 0.4);
}
}
}
}
};
}; var birdObject = new __birdObject();

function __dragonBoss() {
__instance_init__(this, dragonBoss, null, 1, 1, dragonSpr, 1, 196);
this.on_creation = function() {
with(this) {
this.maxHP = 10;
this.HP = this.maxHP;
...
this.frameTime = 10;
this.breathTime = 10;
this.breathTimeout = 0;
this.isBreathing = false;
this.breathingCooldown = 0;
this.breathingHeat = 0;
}
};
this.on_destroy = on_destroy_i;
this.on_step = function() {
...
if(instance_list(Player).length > 0)
{
direction = point_direction(x, y, instance_list(Player)[0].x, instance_list(Player)[0].y);
if(point_distance(x, y, instance_list(Player)[0].x, instance_list(Player)[0].y) <= 200)
{
isBreathing = true;
}
else
...
if(isBreathing && ! breathingCooldown)
{
if(breathTimeout == 0)
{
this.breathingHeat += 1;
breathTimeout = breathTime;
var crt = instance_create(x, y, dragonFire);
crt.direction = direction;
crt.speed = 2;
}
else
...
if(breathingHeat >= 10)
{
breathingCooldown = true;
}
}

if(breathingCooldown)
{
this.breathingHeat -= 1;
if(this.breathingHeat <= 0)
{
breathingCooldown = false;
}
}
...
this.on_collision = function() {
with(this) {
this.other = this.place_meeting(this.x, this.y, playerBullet);
if(this.other != null) {
HP -= 1;
...
__handle_sprite__(this);
with(this) {
switch(Math.floor(frame/frameTime))
{
case 0:
draw_sprite_ext(dragonSpr, 0, x, y, 1, 1, direction, 1);
break;
case 1:
draw_sprite_ext(dragonSpr, 1, x, y, 1, 1, direction, 1);
break;
case 2:
draw_sprite_ext(dragonSpr, 2, x, y, 1, 1, direction, 1);
break;
case 3:
draw_sprite_ext(dragonSpr, 3, x, y, 1, 1, direction, 1);
break;
case 4:
draw_sprite_ext(dragonSpr, 2, x, y, 1, 1, direction, 1);
break;
...
draw_line(x-64, y-48, x+64, y-48);
draw_set_color(255, 0, 0);
draw_set_linewidth(6);
draw_line(x-64, y-48, x-64 + (128/maxHP)*HP, y-48);
}
if(isBreathing)
{
draw_sprite_ext(dragonBreathSpr, Math.floor(Math.random()*4), x, y, 1, 1, direction, 1);
}
}
}
};
}; var dragonBoss = new __dragonBoss();

function __dragonFire() {
__instance_init__(this, dragonFire, null, 0, -1, dragonFireSpr, 1, 197);
this.on_creation = function() {
with(this) {
this.init = false;
this.flyingHeight = 0;
...
init = true;
visible = true;
if(instance_list(Player) > 0)
{
flyingHeight = instance_list(Player).totalHeight;
}
}
if(lifeTime > 0)
{
...
if(instance_list(Player).length > 0)
{
if(instance_list(Player).totalHeight >= flyingHeight-200 && instance_list(Player).totalHeight <= flyingHeight+200)
{
depth = -1;
draw_sprite_ext(dragonFireSpr, Math.floor(frame/frameTime), x, y, 1.2, 1.2, direction, 1);
draw_sprite_ext(dragonFireSpr, Math.floor(frame/frameTime), x, y, 1.2, 1.2, direction, 1);
}
else if(instance_list(Player).totalHeight > flyingHeight)
{
depth = 1;
draw_sprite_ext(dragonFireSpr, Math.floor(frame/frameTime), x, y, 0.8, 0.8, direction, 0.8);
}
else
{
depth = -2;
draw_sprite_ext(dragonFireSpr, Math.floor(frame/frameTime), x, y, 1.5, 1.5, direction, 0.8);
}
}
}
}
};
}; var dragonFire = new __dragonFire();

function __playerBullet() {
__instance_init__(this, playerBullet, null, 1, 1, bulletSpr, 1, 198);
this.on_creation = function() {
with(this) {
this.init = false;
this.flyingHeight = 0;
...
if(instance_list(Player).length > 0)
{
if(instance_list(Player).totalHeight >= flyingHeight-100 && instance_list(Player).totalHeight <= flyingHeight+100)
{
depth = 0;
draw_sprite_ext(bulletSpr, 0, x, y, 2, 2, direction, 1);
}
}
}
}
};
}; var playerBullet = new __playerBullet();

function __GUIController() {
__instance_init__(this, GUIController, null, 1, -5, null, 1, 214);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
if(instance_list(Player).length > 0)
{
draw_sprite_ext(heightLine, 0, room_viewport_x+440, room_viewport_y+480, 1, 1/instance_list(Player)[0].heightMax*instance_list(Player)[0].totalHeight, 0, 0.4);
draw_sprite_ext(heightLine, 0, room_viewport_x+440, room_viewport_y+480, 1, 1/instance_list(Player)[0].heightMax*instance_list(Player)[0].totalHeight, 0, 0.4);
draw_sprite_ext(whiteLine, 0, room_viewport_x+440, room_viewport_y+0, 1, 1-(1/instance_list(Player)[0].heightMax*instance_list(Player)[0].totalHeight), 0, 0.4);
draw_sprite_ext(staminaLine, 0, room_viewport_x+0, room_viewport_y+480, 1, 1/instance_list(Player)[0].energyMax*instance_list(Player)[0].totalEnergy, 0, 0.4);
draw_sprite_ext(staminaLine, 0, room_viewport_x+0, room_viewport_y+480, 1, 1/instance_list(Player)[0].energyMax*instance_list(Player)[0].totalEnergy, 0, 0.4);
draw_sprite_ext(whiteLine, 0, room_viewport_x+0, room_viewport_y+0, 1, 1-(1/instance_list(Player)[0].energyMax*instance_list(Player)[0].totalEnergy), 0, 0.4);
draw_set_color(0, 200, 255);
draw_set_linewidth(4);
draw_set_alpha(0.5);
draw_line(room_viewport_x+440, room_viewport_y+480-480/instance_list(Player)[0].heightMax*instance_list(Player)[0].targetHeight, room_viewport_x+480, room_viewport_y+480-480/instance_list(Player)[0].heightMax*instance_list(Player)[0].targetHeight);
draw_sprite_ext(heightLabel, 0, room_viewport_x+440, room_viewport_y+0, 1, 1, 0, 1);
draw_sprite_ext(heightLineBorder, 0, room_viewport_x+440, room_viewport_y+0, 1, 1, 0, 1);
draw_sprite_ext(staminaLabel, 0, room_viewport_x+0, room_viewport_y+0, 1, 1, 0, 1);
draw_sprite_ext(heightLineBorder, 0, room_viewport_x+0, room_viewport_y+0, 1, 1, 0, 1);
if(! instance_list(Player)[0].started)
{
draw_sprite_ext(startScreen, 0, room_viewport_x, room_viewport_y, 1, 1, 0, 1);
}
}
}
}
};
}; var GUIController = new __GUIController();

function __restartButton() {
__instance_init__(this, restartButton, null, 1, 0, null, 1, 216);
this.on_creation = function() {
with(this) {
if(global.leftAudio <= 0)
{
sound_stop_all();
sound_play(GameOverMusic);
global.leftAudio = 15*60;
}
...
this.objects = [
[{o:heigthRock1, x:3003, y:741}],
[{o:heigthRock1, x:3016, y:767}],
[{o:heigthRock1, x:3003, y:793}],
[{o:heigthRock1, x:2977, y:793}],
[{o:heigthRock1, x:2938, y:793}],
[{o:heigthRock1, x:2925, y:806}],
[{o:heigthRock1, x:2886, y:793}],
[{o:heigthRock1, x:2912, y:767}],
[{o:heigthRock1, x:2938, y:741}],
[{o:heigthRock1, x:2964, y:741}],
[{o:heigthRock1, x:2964, y:767}],
[{o:heigthRock1, x:2873, y:819}],
[{o:heigthRock1, x:2834, y:832}],
[{o:heigthRock1, x:2782, y:819}],
[{o:heigthRock1, x:2743, y:819}],
[{o:heigthRock1, x:2717, y:832}],
[{o:heigthRock1, x:2678, y:858}],
[{o:heigthRock1, x:2639, y:871}],
[{o:heigthRock1, x:2665, y:884}],
[{o:heigthRock1, x:2704, y:884}],
[{o:heigthRock1, x:2743, y:897}],
[{o:heigthRock1, x:2756, y:897}],
[{o:heigthRock1, x:2782, y:871}],
[{o:heigthRock1, x:2808, y:858}],
[{o:heigthRock1, x:2743, y:858}],
[{o:heigthRock1, x:2509, y:572}],
[{o:heigthRock1, x:2522, y:572}],
[{o:heigthRock1, x:2548, y:598}],
[{o:heigthRock1, x:2509, y:598}],
[{o:heigthRock1, x:2327, y:598}],
[{o:heigthRock1, x:2353, y:624}],
[{o:heigthRock1, x:2314, y:637}],
[{o:heigthRock1, x:2288, y:611}],
[{o:heigthRock1, x:2249, y:624}],
[{o:heigthRock1, x:2275, y:637}],
[{o:heigthRock1, x:2236, y:663}],
[{o:heigthRock1, x:2184, y:741}],
[{o:heigthRock1, x:2197, y:715}],
[{o:heigthRock1, x:2197, y:676}],
[{o:heigthRock1, x:2197, y:637}],
[{o:heigthRock1, x:2171, y:650}],
[{o:heigthRock1, x:2158, y:637}],
[{o:heigthRock1, x:2119, y:663}],
[{o:heigthRock1, x:2093, y:676}],
[{o:heigthRock1, x:2067, y:728}],
[{o:heigthRock1, x:2093, y:702}],
[{o:heigthRock1, x:2119, y:715}],
[{o:heigthRock1, x:2145, y:715}],
[{o:heigthRock1, x:2145, y:676}],
[{o:heigthRock1, x:2171, y:1001}],
[{o:heigthRock1, x:2184, y:1040}],
[{o:heigthRock1, x:1820, y:1170}],
[{o:heigthRock1, x:1781, y:1183}],
[{o:heigthRock1, x:1755, y:1209}],
[{o:heigthRock1, x:1794, y:1222}],
[{o:heigthRock1, x:1729, y:1079}],
[{o:heigthRock1, x:1729, y:1027}],
[{o:heigthRock1, x:1755, y:1027}],
[{o:heigthRock1, x:1794, y:1040}],
[{o:heigthRock1, x:1781, y:1066}],
[{o:heigthRock1, x:1768, y:1079}],
[{o:heigthRock1, x:1729, y:1053}],
[{o:heigthRock1, x:1716, y:1040}],
[{o:heigthRock1, x:1755, y:819}],
[{o:heigthRock1, x:1781, y:806}],
[{o:heigthRock1, x:1820, y:806}],
[{o:heigthRock1, x:1833, y:832}],
[{o:heigthRock1, x:1859, y:858}],
[{o:heigthRock1, x:1846, y:871}],
[{o:heigthRock1, x:1820, y:884}],
[{o:heigthRock1, x:1781, y:910}],
[{o:heigthRock1, x:1742, y:923}],
[{o:heigthRock1, x:1716, y:897}],
[{o:heigthRock1, x:1729, y:871}],
[{o:heigthRock1, x:1742, y:845}],
[{o:heigthRock1, x:1755, y:884}],
[{o:heigthRock1, x:1781, y:858}],
[{o:heigthRock1, x:1482, y:1170}],
[{o:heigthRock1, x:1534, y:1131}],
[{o:heigthRock1, x:1547, y:1157}],
[{o:heigthRock1, x:1521, y:1157}],
[{o:heigthRock1, x:1508, y:1014}],
[{o:heigthRock1, x:1521, y:975}],
[{o:heigthRock1, x:1521, y:936}],
[{o:heigthRock1, x:1547, y:910}],
[{o:heigthRock1, x:1573, y:897}],
[{o:heigthRock1, x:1547, y:897}],
[{o:heigthRock1, x:1508, y:897}],
[{o:heigthRock1, x:1495, y:923}],
[{o:heigthRock1, x:1599, y:650}],
[{o:heigthRock1, x:1560, y:663}],
[{o:heigthRock1, x:1573, y:689}],
[{o:heigthRock1, x:1547, y:715}],
[{o:heigthRock1, x:1508, y:741}],
[{o:heigthRock1, x:1469, y:754}],
[{o:heigthRock1, x:1547, y:702}],
[{o:heigthRock1, x:676, y:1508}],
[{o:heigthRock1, x:663, y:1482}],
[{o:heigthRock1, x:689, y:1469}],
[{o:heigthRock1, x:728, y:1482}],
[{o:heigthRock1, x:780, y:1443}],
[{o:heigthRock1, x:767, y:1469}],
[{o:heigthRock1, x:767, y:1495}],
[{o:heigthRock1, x:793, y:1495}],
[{o:heigthRock1, x:819, y:1495}],
[{o:heigthRock1, x:858, y:1482}],
[{o:heigthRock1, x:871, y:1469}],
[{o:heigthRock1, x:858, y:1443}],
[{o:heigthRock1, x:832, y:1430}],
[{o:heigthRock1, x:806, y:1430}],
[{o:heigthRock1, x:806, y:1443}],
[{o:heigthRock1, x:780, y:1430}],
[{o:heigthRock1, x:741, y:1248}],
[{o:heigthRock1, x:767, y:1248}],
[{o:heigthRock1, x:819, y:1248}],
[{o:heigthRock1, x:858, y:1235}],
[{o:heigthRock1, x:884, y:1222}],
[{o:heigthRock1, x:858, y:1183}],
[{o:heigthRock1, x:832, y:1209}],
[{o:heigthRock1, x:793, y:1235}],
[{o:heigthRock1, x:897, y:1144}],
[{o:heigthRock1, x:1105, y:962}],
[{o:heigthRock1, x:1105, y:1014}],
[{o:heigthRock1, x:1131, y:1014}],
[{o:heigthRock1, x:1170, y:988}],
[{o:heigthRock1, x:1131, y:1027}],
[{o:heigthRock1, x:1105, y:1040}],
[{o:heigthRock1, x:1066, y:1040}],
[{o:heigthRock1, x:1014, y:1053}],
[{o:heigthRock1, x:975, y:1040}],
[{o:heigthRock1, x:962, y:1079}],
[{o:heigthRock1, x:1066, y:1053}],
[{o:heigthRock1, x:1027, y:1079}],
[{o:heigthRock1, x:988, y:1118}],
[{o:heigthRock1, x:949, y:1144}],
[{o:heigthRock1, x:923, y:1105}],
[{o:heigthRock1, x:949, y:1118}],
[{o:heigthRock1, x:910, y:1170}],
[{o:heigthRock1, x:884, y:1196}],
[{o:heigthRock1, x:1209, y:962}],
[{o:heigthRock1, x:494, y:1456}],
[{o:heigthRock1, x:520, y:1495}],
[{o:heigthRock1, x:559, y:1521}],
[{o:heigthRock1, x:572, y:1547}],
[{o:heigthRock1, x:546, y:1534}],
[{o:heigthRock1, x:520, y:1573}],
[{o:heigthRock1, x:546, y:1573}],
[{o:heigthRock1, x:494, y:1599}],
[{o:heigthRock1, x:520, y:1625}],
[{o:heigthRock1, x:559, y:1651}],
[{o:heigthRock1, x:598, y:1664}],
[{o:heigthRock1, x:624, y:1677}],
[{o:heigthRock1, x:650, y:1690}],
[{o:heigthRock1, x:689, y:1677}],
[{o:heigthRock1, x:715, y:1690}],
[{o:heigthRock1, x:702, y:1729}],
[{o:heigthRock1, x:702, y:1755}],
[{o:heigthRock1, x:702, y:1794}],
[{o:heigthRock1, x:663, y:1833}],
[{o:heigthRock1, x:650, y:1859}],
[{o:heigthRock1, x:611, y:1859}],
[{o:heigthRock1, x:663, y:1846}],
[{o:heigthRock1, x:585, y:1833}],
[{o:heigthRock1, x:533, y:1846}],
[{o:heigthRock1, x:546, y:1820}],
[{o:heigthRock1, x:533, y:1781}],
[{o:heigthRock1, x:533, y:1755}],
[{o:heigthRock1, x:559, y:1716}],
[{o:heigthRock1, x:559, y:1677}],
[{o:heigthRock1, x:598, y:1703}],
[{o:heigthRock1, x:650, y:1716}],
[{o:heigthRock1, x:663, y:1755}],
[{o:heigthRock1, x:663, y:1794}],
[{o:heigthRock1, x:611, y:1820}],
[{o:heigthRock1, x:559, y:1794}],
[{o:heigthRock1, x:572, y:1742}],
[{o:heigthRock1, x:598, y:1742}],
[{o:heigthRock1, x:624, y:1781}],
[{o:heigthRock1, x:390, y:2015}],
[{o:heigthRock1, x:416, y:2015}],
[{o:heigthRock1, x:442, y:2015}],
[{o:heigthRock1, x:468, y:2041}],
[{o:heigthRock1, x:455, y:2054}],
[{o:heigthRock1, x:442, y:2080}],
[{o:heigthRock1, x:416, y:2080}],
[{o:heigthRock1, x:390, y:2054}],
[{o:heigthRock1, x:416, y:2054}],
[{o:Player, x:1911, y:897}],
[{o:windGenerator, x:2262, y:988}],
[{o:windGenerator, x:2106, y:572}],
[{o:windGenerator, x:1638, y:793}],
[{o:birdObject, x:1940, y:640}],
[{o:birdObject, x:1420, y:1000}],
[{o:birdObject, x:880, y:1040}],
[{o:birdObject, x:2740, y:640}],
[{o:birdObject, x:2900, y:900}],
[{o:birdObject, x:1960, y:1180}],
[{o:windGenerator, x:1600, y:1080}],
[{o:windGenerator, x:1020, y:960}],
[{o:windGenerator, x:320, y:2120}],
[{o:dragonBoss, x:660, y:1600}],
[{o:windGenerator, x:580, y:1440}],
[{o:windGenerator, x:800, y:1600}],
[{o:windGenerator, x:2820, y:740}],
[{o:windGenerator, x:3080, y:780}],
[{o:birdObject, x:540, y:2000}],
[{o:windGenerator, x:600, y:1920}],
[{o:GUIController, x:80, y:180}]];
this.start = function() {
__room_start__(this, game, 3200, 2400, 60, 0, 0, 0, highLevel.image, 0, 0, 1, 480, 480, Player, 240, 240);
...
this.objects = [
[{o:restartButton, x:20, y:20}]];
this.start = function() {
__room_start__(this, badFinal, 480, 480, 30, 0, 0, 0, badFinalText.image, 0, 0, 1, 480, 480, null, 50, 50);
};
}
var badFinal = new __badFinal();
tu_scenes.push(badFinal);
function __goodFinal() { 
this.tiles = [
];
this.objects = [
[{o:restartButton, x:20, y:20}]];
this.start = function() {
__room_start__(this, goodFinal, 480, 480, 30, 0, 0, 0, goodFinalText.image, 0, 0, 1, 480, 480, null, 50, 50);
};
}
var goodFinal = new __goodFinal();
tu_scenes.push(goodFinal);
tu_room_to_go = game;
